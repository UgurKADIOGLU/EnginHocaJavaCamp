...
public class PDVKPSPublicSoap
{
    ...
    public PDVKPSPublicSoap(){}

    public PDVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PDVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PDVExtendedSoapSerializationEnvelope envelope= new PDVExtendedSoapSerializationEnvelope(PDVExtendedSoapSerializationEnvelope.VER11);
