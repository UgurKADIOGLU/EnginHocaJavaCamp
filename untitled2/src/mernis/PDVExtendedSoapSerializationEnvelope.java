...
public class PDVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PDVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PDVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PDVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PDVDateTimeConverter dateTimeConverter = new PDVStandardDateTimeConverter();

    public PDVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PDVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PDVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PDVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PDVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PDVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
